  ...
  return (
    <div className="bg-white flex flex-col items-start relative w-full">
      ...
      <div className="relative z-10 flex flex-col gap-12 lg:gap-24 w-full px-6 lg:px-48 pb-24 lg:pb-40">
        ...
        <Step stepNumber="2" title="Travel to Manhattan" circleRef={step2CircleRef}>
          <span className="font-normal">Travel to Manhattan with 100 other players, where you'll team up and strategize before the game starts.</span>
        </Step>
