      ...
      <PageHeading
        ...
        subtitle={
          <>
            ...
            <br />
            <Link href="/orders/index" method="post" className="mt-2 inline-block bg-black px-4 py-1.5 font-bold text-white no-underline transition-colors hover:bg-[#fecb0d] hover:text-black">
              View Orders
            </Link>
          </>
        }
