...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { href: "/projects", label: "Projects", icon: ProjectsIcon, color: "bg-blue-600" },
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <Link href="/auth/logout" method="post" as="button" className="text-gray-400 hover:text-white">Logout</Link>
                </div>
              </div>
            </div>
          </div>
